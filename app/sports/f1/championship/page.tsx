...
/** Damier SVG net (le conic-gradient CSS produit des bords baveux). */
...
const CHECKER_TILE = `url("data:image/svg+xml,${encodeURIComponent(
...
/** Texte géant contourné (outline), signature visuelle de la page. */
function OutlineText({ children, className, stroke }: {
                ...
                <div className="relative max-w-6xl mx-auto">
                    ...
                    {status === 'ready' && races.length > 0 && (
                        <>
                            ...
                            {/* ── Next race spotlight ── */}
                            {nextRace && countdown && (
                                <div ref={spotlightRef} className="relative mb-14" style={{ opacity: 0 }}>
                                    <div
                                    ...
                                    >
                                        ...
                                        <div
                                            ...
                                            style={{
                                                background:
                                                    'radial-gradient(ellipse at 20% 0%, rgba(126,34,206,0.16) 0%, transparent 55%)',
                                            }}
                                        />
                                        {/* Numéro de manche géant contourné */}
                                        <div className="absolute -right-2 -bottom-10 pointer-events-none">
                                            <OutlineText
                                                className="text-[170px] md:text-[240px]"
                                                stroke="1px rgba(255,255,255,0.07)"
                                            >
                                            ...
                                            <div>
                                                <div className="flex items-center gap-3 mb-5">
                                                    ...
                                                    <span className="text-xs font-mono tracking-[0.35em] text-purple-400 uppercase">
                                                        Up next — Round {nextRace.round} of {races.length}
                                                    </span>
                                                </div>
                                                <h3
                                                ...
                                                <div className="flex flex-wrap items-center gap-3">
                                                    <span className="px-4 py-1.5 border border-white/15 -skew-x-12 text-white text-xs tracking-[0.15em] uppercase font-medium">
                                                        <span className="inline-block skew-x-12">{formatFullDate(nextRace.date)}</span>
                                                    </span>
                                                    {nextRace.sprintWeekend && (
